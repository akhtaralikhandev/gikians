...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fmiddleware_ts_page_2Fmiddleware_rootDir_C_3A_5CUsers_5Cakhtar_20ali_5CDesktop_5Csix_months_mission_5Cfacebook_clone_5Cfacebook_clone_matchers_)
});
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fmiddleware.ts&page=%2Fmiddleware&rootDir=C%3A%5CUsers%5Cakhtar%20ali%5CDesktop%5Csix_months_mission%5Cfacebook_clone%5Cfacebook_clone&matchers=!
        ...
        /* harmony default export */ function next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fmiddleware_ts_page_2Fmiddleware_rootDir_C_3A_5CUsers_5Cakhtar_20ali_5CDesktop_5Csix_months_mission_5Cfacebook_clone_5Cfacebook_clone_matchers_(opts) {
          return adapter({
              ...opts,
              page: "/middleware",
              handler,
...
function middleware(request) {
    ...
    if (!isLogin) {
        if (request.nextUrl.pathname.startsWith("/profile/profile")) {
            return next_dist_server_web_exports_next_response__WEBPACK_IMPORTED_MODULE_0__/* ["default"].rewrite */ .Z.rewrite(new URL("/", request.url));
        }
    //   } else {
    //     if (url.pathname === "/") {
